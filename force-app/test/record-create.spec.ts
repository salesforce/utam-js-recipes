...
// to run:
// yarn test --spec force-app/test/record-create.spec.ts
 ...
 * @param baseUrl test environment
 * @param recordType type of record used in the UI test
 * @returns instance of the record modal Page Object
 */
async function openRecordModal(baseUrl: string, recordType: RecordType): Promise<void> {
